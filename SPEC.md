...
- **Track selection** — Choose from available tracks (Villain Song, Basic Drums, Hoedown, Whose Line Rap, Yucca, etc.) or "None" for metronome-only mode. Each track has its own BPM, and the transport matches it automatically.
