...
- `website/src/lib/rhymes.ts` — `generateBars()` with seeded PRNG (mulberry32), `generateBarsFromGrid()` for grid-based presets/mixes, `buildDisplayBars()` remaps rhyme pool around instrumental sections
